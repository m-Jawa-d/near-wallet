...
export const apiService = {
     ...
     * @param {string} mpcTxHash - MPC transaction hash from v1.signer contract
     * @returns {Promise<Object>} Token response
     */
    async getToken(accountId, nonce, signature, mpcTxHash) {
        try {
            if (!accountId || !nonce || !signature || !mpcTxHash) {
                throw new Error('accountId, nonce, signature, and mpcTxHash are required for this POST request.');
            }
